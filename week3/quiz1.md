...
- 답: crate : 두 브랜치를 공통 부모로 하는 새로운 commit 'E'를 만듦
squash : 하나의 커밋으로 main 브랜치로 병합
rebase : 모두 새로운 커밋으로 변경 
...
- 답: revert, reset은 commit을 삭제하므로 위험, commit을 삭제하기보다 생성하여 되돌리는 revert가 안전 
